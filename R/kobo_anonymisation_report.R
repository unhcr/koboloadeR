...
kobo_anonymisation_report <- function(frame) {
  ...
  write.csv(frame, "data/anomreport.csv", row.names = FALSE, na = "")
  reportanom  <- "code/anonymisation-report-test.Rmd"
  ...
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("household <- read.csv(paste0(mainDirroot,\"/data/anomreport.csv\"), sep = \";\", encoding = \"UTF-8\", na.strings = \"\")", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("#household <- kobo_label(household , dico)", file = reportanom , sep = "\n", append = TRUE)
  cat("numrow <- nrow(household) ", file = reportanom , sep = "\n", append = TRUE)
  cat("numvar <- ncol(household)", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("#############################################################################", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("check <- as.data.frame(names(household))", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("selected.pram <- dico[ which(dico$anonymise == \"sensitive\" & dico$type == \"select_one\" ), ]", file = reportanom , sep = "\n", append = TRUE)
  cat("selected.pram <- join(x = selected.pram, y = check, by = \"fullname\", type = \"left\")", file = reportanom , sep = "\n", append = TRUE)
  cat("selected.pram <- selected.pram[!is.na(selected.pram$id), ]", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("selected.pramVars <- as.character(selected.pram[ , c(\"fullname\")])", file = reportanom , sep = "\n", append = TRUE)
  cat("selected.numVars <- as.character(selected.num[ , c(\"fullname\")])", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("## Sample weight", file = reportanom , sep = "\n", append = TRUE)
  cat("household$weight <- 1", file = reportanom , sep = "\n", append = TRUE)
  cat("selected.weightVar = c('weight')", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("# All variables (id, key variables, pram variables, numerical variables, weights)", file = reportanom , sep = "\n", append = TRUE)
  cat("household$id <- row.names(household)", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("#############################################################################", file = reportanom , sep = "\n", append = TRUE)
  cat("##### Step 2: Assessing disclosure risk (household level) ####", file = reportanom , sep = "\n", append = TRUE)
  cat("# Create subset of file with households and HH variables& Remove duplicated rows based on IDH", file = reportanom , sep = "\n", append = TRUE)
  cat("household.anom <- household[ which(!duplicated(household$id)), c('id',", file = reportanom , sep = "\n", append = TRUE)
  cat(" selected.keyVars,", file = reportanom , sep = "\n", append = TRUE)
  cat(" selected.pramVars,", file = reportanom , sep = "\n", append = TRUE)
  cat(" selected.numVars,", file = reportanom , sep = "\n", append = TRUE)
  cat(" selected.weightVar)]", file = reportanom , sep = "\n", append = TRUE)
  cat("#household.anom <- kobo_label(household.anom , dico)", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("# Create initial sdc object for household level variables", file = reportanom , sep = "\n", append = TRUE)
  cat("sdc.household <- createSdcObj(dat = household.anom,", file = reportanom , sep = "\n", append = TRUE)
  cat(" keyVars = selected.keyVars,", file = reportanom , sep = "\n", append = TRUE)
  cat(" pramVars = selected.pramVars,", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("selected.pram1 <- selected.pram[ , c(\"name\",\"label\")]", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("kable(as.data.frame(selected.pram1), caption = \"__Table__: Sensitive variables\") %>% kable_styling(position = \"center\")", file = reportanom , sep = "\n", append = TRUE)
  cat("```", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("#print(sdc.household, type = \"general\")", file = reportanom , sep = "\n", append = TRUE)
  cat("```", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("print(sdc.household, type = \"risk\")", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("# Global risk percentage", file = reportanom , sep = "\n", append = TRUE)
  cat("#sdc.household@risk$global$risk", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("# Number of expected re-identifications", file = reportanom , sep = "\n", append = TRUE)
  cat("#sdc.household@risk$global$risk_ER", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("# Hierarchical risk percentage", file = reportanom , sep = "\n", append = TRUE)
  cat("#sdc.household@risk$global$hier_risk", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("# Hierarchical risk: number of expected identifications", file = reportanom , sep = "\n", append = TRUE)
  cat("#sdc.household@risk$global$hier_risk_ER", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("riskind <- rep(0, 16)", file = reportanom , sep = "\n", append = TRUE)
  cat(" riskind[1] <- dim(household.anom[sdc.household@risk$individual[, \"risk\"] > 0,])", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("for (i in 1:15)", file = reportanom , sep = "\n", append = TRUE)
  cat("{", file = reportanom , sep = "\n", append = TRUE)
  cat("  riskind[i + 1] <- dim(household.anom[sdc.household@risk$individual[, \"risk\"] > 0.01 * i,])", file = reportanom , sep = "\n", append = TRUE)
  cat("}", file = reportanom , sep = "\n", append = TRUE)
  cat("levelriskind <- c('Risk level is higher than 0%', ", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 1%',", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 2%',", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 3%',", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 4%',", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 5%',", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 6%',", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 7%',", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 8%',", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 9%',", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 10%',", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 11%',", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 12%',", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 13%',", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 14%',", file = reportanom , sep = "\n", append = TRUE)
  cat("                 'Risk level is higher than 15%')", file = reportanom , sep = "\n", append = TRUE)
  cat("names(riskind) <- levelriskind", file = reportanom , sep = "\n", append = TRUE)
  cat("riskind <- as.data.frame(riskind)", file = reportanom , sep = "\n", append = TRUE)
  cat("riskind$label <- row.names(riskind)", file = reportanom , sep = "\n", append = TRUE)
  cat("riskind$label <- factor(riskind$label, levels = levelriskind)", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("riskind$label = with(riskind, factor(label, levels = rev(levels(label))))", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("## and now the graph", file = reportanom , sep = "\n", append = TRUE)
  cat("ggplot(riskind, aes(x = label, y = riskind)) +", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("geom_label_repel(aes(y = riskind, label = riskind), fill = \"#2a87c8\", color = 'white') +", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("# Look at high risk households", file = reportanom , sep = "\n", append = TRUE)
  cat("#high.risk.households <- household.anom[sdc.household@risk$individual[, \"risk\"] > 0.2, selected.keyVars ]", file = reportanom , sep = "\n", append = TRUE)
  cat("#high.risk.households", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("```", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("print(sdc.household, type = \"kAnon\")", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("# Show lines with variables that violate k-anonymity", file = reportanom , sep = "\n", append = TRUE)
  cat("#household.anom[sdc.household@risk$individual[,2] < 3,]", file = reportanom , sep = "\n", append = TRUE)
  cat("#household.anom[sdc.household@risk$individual[,2] < 5,]", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("```", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("for (h in 1:length(selected.pramVars))", file = reportanom , sep = "\n", append = TRUE)
  cat(" {", file = reportanom , sep = "\n", append = TRUE)
  cat("  # h <-1", file = reportanom , sep = "\n", append = TRUE)
  cat(" res1 <- ldiversity(household.anom, keyVars = selected.keyVars, ldiv_index = selected.pramVars[h])", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat(" cat(paste0(\"Displaying l-didersity risk for: \", selected.pram[ h, c(\"label\")], \"\n\"))", file = reportanom , sep = "\n", append = TRUE)
  cat(" # res1", file = reportanom , sep = "\n", append = TRUE)
  cat(" print(res1)", file = reportanom , sep = "\n", append = TRUE)
  cat(" cat(\"\n\")", file = reportanom , sep = "\n", append = TRUE)
  cat(" head(res1)", file = reportanom , sep = "\n", append = TRUE)
  cat(" cat(\"\n\")", file = reportanom , sep = "\n", append = TRUE)
  cat(" }", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("```", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("# Disclosure Risk Control (SDC) treatment", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("### Local suppression", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("```{r suppr, echo = FALSE, warning = FALSE, message = FALSE, eval= TRUE, comment = \"\"}", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("## displays various information if local suppression has been applied", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("sdc.householdk2 <- localSuppression(sdc.household, k = 2, importance = NULL) ", file = reportanom , sep = "\n", append = TRUE)
  cat("sdc.household.localsuppressionk2 <- t(as.data.frame(sdc.householdk2@localSuppression$supps))", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("kable(as.data.frame(sdc.household.localsuppressionk2), caption = \"__Table__: Needed suppression to achieve 2-anonymity\") %>% kable_styling(position = \"center\")", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("sdc.householdk3 <- localSuppression(sdc.household, k = 3, importance = NULL) ", file = reportanom , sep = "\n", append = TRUE)
  cat("sdc.household.localsuppressionk3 <- t(as.data.frame(sdc.householdk3@localSuppression$supps))", file = reportanom , sep = "\n", append = TRUE)
  cat("kable(as.data.frame(sdc.household.localsuppressionk3), caption = \"__Table__: Needed suppression to achieve 3-anonymity\") %>% kable_styling(position = \"center\")", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("#sdc.householdkt15 <- localSupp(sdc.household, threshold = 0.15) ", file = reportanom , sep = "\n", append = TRUE)
  cat("#sdc.household.localsuppressiont15  <- t(as.data.frame(sdc.householdt15@localSuppression$supps))", file = reportanom , sep = "\n", append = TRUE)
  cat("#kable(as.data.frame(sdc.household.localsuppressionk2), caption = \"__Table__: Needed suppression to achieve 15% threshold for individual risk\") %>% kable_styling(position = \"center\")", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("#print(sdc.household, type = \"ls\")", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("```", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("### Recoding categorical key variables", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("Global recoding is a non-perturbative method that can be applied to both categorical and continuous key variables. The basic idea of recoding a categorical variable is to combine several categories into a new, less informative category. ", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("A frequent use case is the recoding of age given in years into age-groups. If the method is applied to a continuous variable, it means to discretize the variable. ", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("print(sdc.household, type = \"recode\")", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("#print(sdc.household, type = \"comp_numvars\")", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("```", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("print(sdc.household, type = \"pram\")", file = reportanom , sep = "\n", append = TRUE)
  cat("```", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("print(sdc.household, type = \"numrisk\")", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("```", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  ...
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("#calcRisks(sdc.household)", file = reportanom , sep = "\n", append = TRUE)
  cat("\n", file = reportanom , sep = "\n", append = TRUE)
  cat("```", file = reportanom , sep = "\n", append = TRUE)
...
file.rename(paste0("code/anonymisation-report.docx"), paste0("out/report-",i,"-", chaptersname,Sys.Date(), "-chapter.docx"))
