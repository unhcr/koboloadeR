#' @name kobo_unhcr_style_histo_big
#' @rdname kobo_unhcr_style_histo_big
#' @title UNHCR ggplot2 theme
#'
#' @description Return ggplot2 styling for histogram with big labels for powerpoints
#'
...
kobo_unhcr_style_histo_big <- function() {
    font <- "Lato"
    ggplot2::theme(

      #This sets the font, size, type and colour of text for the chart's title
      plot.title = ggplot2::element_text(family = font, size = 26, face = "bold", color = "#222222"),
