...
Kooloader is designed to facilitate the analysis workflow of a survey collected through any xlsform compatible platform.

The package is designed to support 2 user flow:

 * __Graphical User Interface - GUI__: A dedicated shynyapp `kobo_shiny("app_main_koboloadeR.R")` includes all instructions and options to run your project.
