...
kobo_Prediction_report <- function(frame) {
  ...
  for (i in 1:length(selected.predictVars)){
    ...
    if(selected.predictVars[i] %in% dico[ which(dico$fullname == selected.predictVars[i] & dico$type == "select_one_d" | dico$listname == "yesnono"), ]$fullname){
      ...
      cat(" ", file = variable.name , sep = "\n", append = TRUE)
      #cat(" source(paste0(mainDirroot,\"/code/0-packages.R\"))", file = variable.name , sep = "\n", append = TRUE)
      #cat(" source(paste0(mainDirroot,\"/code/0-theme.R\"))", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
     ...
     # cat("detach(\"package:pls\", unload=TRUE)", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("              \"subj_assessment.observations\",", file = variable.name , sep = "\n", append = TRUE)
      cat("              \"demo.total_hh\",", file = variable.name , sep = "\n", append = TRUE)
      cat("              \"demo.reg_question.total_number\",", file = variable.name , sep = "\n", append = TRUE)
      cat("              \"demo.reg_question.eighteen_over\",", file = variable.name , sep = "\n", append = TRUE)
      cat("              \"demo.reg_question.eighteen_under\",", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("#                                 selected.predictVars)]", file = variable.name , sep = "\n", append = TRUE)
      cat("# ", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("train <- survey.pro1[ , c(\"edu_highestcat\", \"occupationcat\", \"dem_marriagecat\",\"dem_sex\",", file = variable.name , sep = "\n", append = TRUE)
      cat("                                    \"coal1Cat\", \"cool1Cat\",\"coal2Cat\", \"cool2Cat\", \"dependency\"  , \"female.ratio\",", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("var <- as.factor(train[,ncol(train)])", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("train <- train[train$coal1Cat != \"Other.or.Unknown\" , ]", file = variable.name , sep = "\n", append = TRUE)
      cat("train <- train[train$cool2Cat != \"Other.or.Unknown\" , ]", file = variable.name , sep = "\n", append = TRUE)
      cat("train <- train[train$coal2Cat != \"Other.or.Unknown\" , ]", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("train$coal1Cat <- as.factor(as.character(train$coal1Cat))", file = variable.name , sep = "\n", append = TRUE)
      cat("train$cool1Cat <- as.factor(as.character(train$cool1Cat))", file = variable.name , sep = "\n", append = TRUE)
      cat("#prop.table(table(train$coal1Cat, useNA=\"ifany\"))", file = variable.name , sep = "\n", append = TRUE)
      cat("#prop.table(table(train$cool1Cat, useNA=\"ifany\"))", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("train$coal2Cat <- as.factor(as.character(train$coal2Cat))", file = variable.name , sep = "\n", append = TRUE)
      cat("train$cool2Cat <- as.factor(as.character(train$cool2Cat))", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("## Subset of progres case that can be used to apply the model", file = variable.name , sep = "\n", append = TRUE)
      cat("# pred <- progrescase[ , c(\"CaseNo\",\"Num_Inds1\",  \"edu_highestcat\", \"occupationcat\", \"dem_marriagecat\",\"dem_sex\",", file = variable.name , sep = "\n", append = TRUE)
      cat("#                          \"coal1Cat\",\"cool1Cat\",\"coal2Cat\", \"cool2Cat\", \"dependency\"  , \"female.ratio\",", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat(" ", file = variable.name , sep = "\n", append = TRUE)
      cat("pred$occupationcat[pred$occupationcat==\"UnknownOccup\"] <- NA", file = variable.name , sep = "\n", append = TRUE)
      cat("pred$coal1Cat[pred$coal1Cat==\"Other.or.Unknown\"] <- NA", file = variable.name , sep = "\n", append = TRUE)
      cat("pred$coal2Cat[pred$coal2Cat==\"Other.or.Unknown\"] <- NA", file = variable.name , sep = "\n", append = TRUE)
      cat("pred$cool1Cat[pred$cool1Cat==\"Other.or.Unknown\"] <- NA", file = variable.name , sep = "\n", append = TRUE)
      cat("pred$cool2Cat[pred$cool2Cat==\"Other.or.Unknown\"] <- NA", file = variable.name , sep = "\n", append = TRUE)
      cat(" pred$coal1Cat <-  factor(pred$coal1Cat, levels = levels(train$coal1Cat))", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("#pred<-pred[!duplicated(pred),]", file = variable.name , sep = "\n", append = TRUE)
      cat("pred <- hotdeck(pred,imp_var = FALSE)  #basic imputation method", file = variable.name , sep = "\n", append = TRUE)
      cat("anyNA(pred)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("#progrescase<-VIM::kNN(data=pred, variable=\"occupationcat\", metric = NULL, k = 5,", file = variable.name , sep = "\n", append = TRUE)
      cat(" # dist_var = colnames(pred), weights = NULL, numFun = median,", file = variable.name , sep = "\n", append = TRUE)
      cat("  #catFun = maxCat, makeNA = NULL, NAcond = NULL, impNA = TRUE,", file = variable.name , sep = "\n", append = TRUE)
      cat("  #donorcond = NULL, mixed = vector(), mixed.constant = NULL,", file = variable.name , sep = "\n", append = TRUE)
      cat("  #trace = FALSE, imp_var = TRUE, imp_suffix = \"imp\", addRandom = FALSE,", file = variable.name , sep = "\n", append = TRUE)
      cat("  #useImputedDist = TRUE, weightDist = FALSE)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("#write CSV Files", file = variable.name , sep = "\n", append = TRUE)
      cat("#write.csv(train,paste0(mainDirroot,\"/out/train.csv\"))", file = variable.name , sep = "\n", append = TRUE)
      cat("#write.csv(reg_question.pro1.wfp,paste0(mainDirroot,\"/out/reg_question.pro1.wfp.csv\"))", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("# rm(reg_question.pro1,reg_question.pro1.wfp, )", file = variable.name , sep = "\n", append = TRUE)
      cat("#rm( reg_question.pro,  reg_question,  progrescase, pred, jva.wfp, dico)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("The purpose of this section is to build predictions of the variables of interest using the registration data. Several statistical models are considered and the best one will be used to create predictions.", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("The original sample is divided into two datasets. A training one is used to build each model and a testing one is used to validate them. ", file = variable.name , sep = "\n", append = TRUE)
      cat("The criterion giving the best model is the accuracy of prediction, that is the proportion of predicted modalities that fit actual ones, using the testing dataset.", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("##Modelisation", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("A decision tree is an algorithm that builds a tree like graph to illustrate the possible outcomes of a decision. To build the tree, the algorithm first finds the predictive variable that does the best task of separating the data into two groups. Then, it repeats the above step with the other variables. The results in a tree graph, where each split represents a decision. The algorithm chooses the splits such that the maximum number of observations are classified correctly. ", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("                   method=\"class\",control=rpart.control(minsplit=2, minbucket=1, cp=0.005))", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("###Random Forest model", file = variable.name , sep = "\n", append = TRUE)
      cat("In Random Forests the idea is to generate several decision trees using different samples randomly chosen from training data. The next step is to simply reduce the variance in the trees by averaging them.", file = variable.name , sep = "\n", append = TRUE)
      cat("Averaging the trees reduces the variance and also improves the perfomance of decision trees on test set and eventually avoids. overfitting (that is a too strong dependency of the model on the training set).", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("```", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("The following chart orders the predictors according to their classification capacity.", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```{r, random forest plot,  echo = FALSE, warning = FALSE, message = FALSE}", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("To build predictions, the chosen model is the one with the highest accuracy.", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("table2 <- as.data.frame(prop.table(table(pred2$coal1Cat, pred2$fitted.results.var )))", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
    ...
    if(selected.predictVars[i] %in% dico[ which(dico$fullname == selected.predictVars[i] & dico$listname != "yesnono" & dico$type == "select_one"), ]$fullname){
      ...
      cat("pred2 <- pred2[ pred2$YearArrivalCategory != \"2018\", ]", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("#pred2 <- pred2[ !(pred2$coal1Cat %in% c(\"Anbar\", \"Baghdad\")), ]", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2 <- pred2[ pred2$coal1Cat %in% as.character(unique(train$coal1Cat)), ]", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("# rm(reg_question.pro1,reg_question.pro1.wfp, )", file = variable.name , sep = "\n", append = TRUE)
      cat("#rm( reg_question.pro,  reg_question, food, progrescase, pred, jva.wfp, dico)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("## Introduction", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("The purpose of this section is to build predictions of the variable of interest using the registration data. Several statistical models are considered and the best one will be used to create predictions.", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("### Data description", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("The variable that is to be predicted is" ,variablesname, ". The variables used for prediction are taken from the registration data:  education, origin, place of asylum, occupation, family profile, case size, female ratio,", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("The aim of predictive modelisation is to make a link between the variable that is to be predicted and a set of predictive variables called predictors. ", file = variable.name , sep = "\n", append = TRUE)
      cat("The original sample is divided into two datasets. A training one is used to build each model and a testing one is used to validate them. ", file = variable.name , sep = "\n", append = TRUE)
      cat("AUC (Area Under the ROC Curve) is the criterion usedd to draw a comparison between models according to their predictive capacity. An AUC equal to 1 means that the model perfectly predicts the variable of interest while a 0.5 AUC indicates that the model has no predictive capacity at all.", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("The analysis will meet two key concepts:", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("   ", file = variable.name , sep = "\n", append = TRUE)
      cat(" ", file = variable.name , sep = "\n", append = TRUE)
      cat(" *  __Exclusion__: % of \"false negative\", that are the individuals who have a predicted indicator equal to 0 while the actual value is 1", file = variable.name , sep = "\n", append = TRUE)
      cat(" ", file = variable.name , sep = "\n", append = TRUE)
      cat(" *  __Inclusion__: % of \"false positive\", that are the individuals who have a predicted indicator equal to 1 while the actual value is 0", file = variable.name , sep = "\n", append = TRUE)
      cat(" ", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```{r xgboost model,  echo = FALSE, warning = FALSE, message = FALSE}", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```{r confusion matrix,  echo = FALSE, warning = FALSE, message = FALSE}", file = variable.name , sep = "\n", append = TRUE)
      cat("# Confusion Matrix #################", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("cut <- get_cutoff_point(perf_xgb, 1) #obtain the cutoff probability", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("rpart_model <- rpart(var ~  ., data = train,", file = variable.name , sep = "\n", append = TRUE)
      cat("                   method=\"anova\",control=rpart.control(minsplit=2, minbucket=1, cp=0.005))", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("# plot tree ", file = variable.name , sep = "\n", append = TRUE)
      cat("plot(rpart_model, uniform=TRUE)", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("###Random Forest model", file = variable.name , sep = "\n", append = TRUE)
      cat("In Random Forests the idea is to generate several decision trees using different samples randomly chosen from training data. The next step is to simply reduce the variance in the trees by averaging them.", file = variable.name , sep = "\n", append = TRUE)
      cat("Averaging the trees reducea the variance and also improves the perfomance of decision trees on test set and eventually avoid overfitting (that is a too strong dependency of the model on the training set).", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("rf.model <- randomForest(var ~ . , data = train)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("#plot(rf.model)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```{r SVM model,  echo = FALSE, warning = FALSE, message = FALSE}", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("pred_values_svm <- ifelse(svm_model.prob[,2] > cut,1,0)", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("The goal of Logistic Regression is to evaluate the probability of a discrete outcome occurring, based on the observations. Logistic Regression allows us to compute this probability based on a logistic function. Then a decision boundary is used to pass from probabilities to classification.", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      # cat("train$notvuln <- NULL", file = variable.name , sep = "\n", append = TRUE)
      cat("for (i in 1:(length(train)-1)){test[,i] <- factor(test[,i], levels = levels(train[,i]))}", file = variable.name , sep = "\n", append = TRUE)
      cat("LR_model <- glm(var ~  .,", file = variable.name , sep = "\n", append = TRUE)
      cat("                   family = binomial(link = 'logit'), data = train)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("#summary(LR_model)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("## Display a graph with all variables contribution", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("#ggcoef(LR_model, exponentiate = FALSE)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("## Review model best on better variable", file = variable.name , sep = "\n", append = TRUE)
      cat("#drop1(LR_model, test = \"Chisq\")", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("```", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```{r LR model 2, echo = FALSE, warning = FALSE, message = FALSE}", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("## Chart to show the coeeficient of the model", file = variable.name , sep = "\n", append = TRUE)
      cat("#ggcoef(LR_model2, exponentiate = TRUE,conf.int=TRUE)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("## Displaing odd ratio with questionR", file = variable.name , sep = "\n", append = TRUE)
      cat("#odds.ratio(LR_model2)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("## Ploting all effect with library effects", file = variable.name , sep = "\n", append = TRUE)
      cat("#plot(allEffects(LR_model2))", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```{r LR model 3, include = FALSE, echo = FALSE, warning = FALSE, message = FALSE}", file = variable.name , sep = "\n", append = TRUE)
      cat("### Testing interaction for the variable with glmulti #######", file = variable.name , sep = "\n", append = TRUE)
      cat("#names(train_dicho)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("# rma.glmulti <- function(formula, data, ...)", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("# ", file = variable.name , sep = "\n", append = TRUE)
      cat("# ", file = variable.name , sep = "\n", append = TRUE)
      cat("# res <- glmulti(LR_model2$formula,", file = variable.name , sep = "\n", append = TRUE)
      cat("#                data = train,", file = variable.name , sep = "\n", append = TRUE)
      cat("#                level = 2,", file = variable.name , sep = "\n", append = TRUE)
      cat("#              #  fitfunction = rma.glmulti,", file = variable.name , sep = "\n", append = TRUE)
      cat("#              #  fitfunction = myglm,", file = variable.name , sep = "\n", append = TRUE)
      cat("#                crit = \"aicc\",", file = variable.name , sep = "\n", append = TRUE)
      cat("#                plotty = FALSE)", file = variable.name , sep = "\n", append = TRUE)
      cat("#              #  confsetsize = 128) ###mettre une limite", file = variable.name , sep = "\n", append = TRUE)
      cat("# ", file = variable.name , sep = "\n", append = TRUE)
      cat("# #print(res)", file = variable.name , sep = "\n", append = TRUE)
      cat("# #plot(res)", file = variable.name , sep = "\n", append = TRUE)
      cat("# tmp <- weightable(res)", file = variable.name , sep = "\n", append = TRUE)
      cat("# tmp <- tmp[tmp$aicc <= min(tmp$aicc) + 2,]", file = variable.name , sep = "\n", append = TRUE)
      cat("# #tmp", file = variable.name , sep = "\n", append = TRUE)
      cat("# #summary(res@objects[[1]])", file = variable.name , sep = "\n", append = TRUE)
      cat("# ", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("#coef(LR_model2)[2]", file = variable.name , sep = "\n", append = TRUE)
      cat("#coef(LR_model2)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```{r LR model 4,  echo = FALSE, warning = FALSE, message = FALSE}", file = variable.name , sep = "\n", append = TRUE)
      cat("# draw Logistic regression confusion matrix #####", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("#rf", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2$food<-NULL", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2$food<-NULL", file = variable.name , sep = "\n", append = TRUE)
      cat("train$var <- NULL", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2$Case.size.1<-NULL", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("table <- as.data.frame(prop.table(table(pred2$fitted.results.var )))", file = variable.name , sep = "\n", append = TRUE)
      cat("summary(train$var)", file = variable.name , sep = "\n", append = TRUE)
      cat("## Format table", file = variable.name , sep = "\n", append = TRUE)
      cat("table$Freq <- paste0(round(table$Freq*100,digits = 1),\"%\")", file = variable.name , sep = "\n", append = TRUE)
      cat("table <- table[ ,c(\"Var1\",\"Freq\" )]", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("positive <- subset(pred2, pred2$fitted.results.var==1)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("table2 <- as.data.frame(prop.table(table(positive$coal1Cat )))", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("## Format table", file = variable.name , sep = "\n", append = TRUE)
      cat("table2$Freq <- paste0(round(table2$Freq*100,digits = 1),\"%\")", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("geom_bar(color = \"white\",fill = \"#2a87c8\",stat = \"identity\",width=0.5) +", file = variable.name , sep = "\n", append = TRUE)
      cat("labs(x = \"\", y = \"Frequency\") +", file = variable.name , sep = "\n", append = TRUE)
      cat("ggtitle(\"Repartition of the refugees with positive indicator\")+", file = variable.name , sep = "\n", append = TRUE)
      cat("theme(plot.title = element_text(face = \"bold\", size = 9), plot.background = element_rect(fill = \"transparent\",colour = NA))", file = variable.name , sep = "\n", append = TRUE)
      cat("                   ", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("#install.packages(\"lintr\")", file = variable.name , sep = "\n", append = TRUE)
    ...
    if(selected.predictVars[i] %in% dico[ which(dico$fullname == selected.predictVars[i] & dico$type == "integer"), ]$fullname){
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("### let's remove the unknownGTK", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2 <- pred2[pred2$cool1Cat != \"Other.or.Unknown\", ]", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2 <- pred2[pred2$coal1Cat != \"Other.or.Unknown\" , ]", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2 <- pred2[pred2$cool2Cat != \"Other.or.Unknown\" , ]", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2 <- pred2[pred2$coal2Cat != \"Other.or.Unknown\" , ]", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2$coal1Cat <- as.factor(as.character(pred2$coal1Cat))", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2$cool1Cat <- as.factor(as.character(pred2$cool1Cat))", file = variable.name , sep = "\n", append = TRUE)
      cat("#prop.table(table(train$coal1Cat, useNA=\"ifany\"))", file = variable.name , sep = "\n", append = TRUE)
      cat("#prop.table(table(train$cool1Cat, useNA=\"ifany\"))", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2$coal2Cat <- as.factor(as.character(pred2$coal2Cat))", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2$cool2Cat <- as.factor(as.character(pred2$cool2Cat))", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("nrow.train <- nrow(train)", file = variable.name , sep = "\n", append = TRUE)
      cat("nrow.pred <- nrow(pred)", file = variable.name , sep = "\n", append = TRUE)
      cat("nrow.pred2 <- nrow(pred2)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("#create a numeric variable to try models", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("#write CSV Files", file = variable.name , sep = "\n", append = TRUE)
      cat("#write.csv(train,paste0(mainDirroot,\"/out/train.csv\"))", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("The aim of predictive modelisation is to make a link between the variable that is to be predicted and a set of predictive variables called predictors. ", file = variable.name , sep = "\n", append = TRUE)
      cat("The original sample is divided into two datasets. A training one is used to build each model and a testing one is used to validate them. ", file = variable.name , sep = "\n", append = TRUE)
      cat("Correlation between predicted and actual values (from the testing dataset) is the criterion used to draw a comparison between the models according to their predictive capacity. The higher the correlation the better the prediction.", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```{r datasets,  echo = FALSE, warning = FALSE, message = FALSE}", file = variable.name , sep = "\n", append = TRUE)
      cat("train <- hotdeck(train, imp_var = FALSE)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("#Removing constant variables", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("train_Y = as.numeric(train_dicho$var)", file = variable.name , sep = "\n", append = TRUE)
      cat("train_dicho$var <- NULL", file = variable.name , sep = "\n", append = TRUE)
      cat("train_dicho$FSRec <- NULL", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("test_Y = test_dicho$var", file = variable.name , sep = "\n", append = TRUE)
      cat("#test_dicho$var <- NULL", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2_dicho <- as.data.frame(c(acm.disjonctif(pred2[,sapply(pred2, is.factor)]), pred2[sapply(pred2, is.numeric)]))", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2_dicho[] <- lapply(pred2_dicho, as.numeric)  ", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("pred2_dicho<-subset(pred2_dicho,select = names(pred2_dicho) %in% colnames(train_dicho))", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("lm.predict <- predict(LM2, test)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("correlation_accuracy_LM <- abs(cor(actuals_preds_LM)[3])  # 5.17%", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("GLM2 <- step(GLM, steps = 5)", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("glm.predict <- predict(GLM2, test)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("#Compute the correlation between predicted and actual values", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```{r, echo = FALSE, warning = FALSE, message = FALSE}", file = variable.name , sep = "\n", append = TRUE)
      cat("ggcoef(GLM2, exponentiate = TRUE,conf.int=TRUE)", file = variable.name , sep = "\n", append = TRUE)
      cat("```", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```{r, include = FALSE, echo = FALSE, warning = FALSE, message = FALSE}", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("PLS regression is a technique that generalizes and combines features from principal component analysis and multiple regression. It is particularly useful when the set of predictors is large and with multicolinearity in it. It reduces the predictors to a smaller set of uncorrelated components and performs least squares regression on these components, instead of on the original data.", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("pls.predict <- predict(plsFit, pred2)", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("#Compute the correlation between predicted and actual values", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("correlation_accuracy_pls <- abs(cor(actuals_preds_pls)[3])  # 5.17%", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("###Lasso regression", file = variable.name , sep = "\n", append = TRUE)
      cat("Lasso regression (Least Absolute Shrinkage and Selection Operator) is a type of linear regression that uses shrinkage and variable selection. Shrinkage is where data values are contracted towards a central point, like the mean. The lasso procedure encourages simple models (with fewer parameters). This type of regression is well-suited for models showing high levels of muticollinearity (that is high intercorrelations or inter-associations among predictors).", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("correlation_accuracy_lasso <- abs(cor(actuals_preds_lasso)[3])  # 5.17%", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("### Decision tree ", file = variable.name , sep = "\n", append = TRUE)
      cat("A decision tree is an algorithm that builds a tree like graph to illustrate the possible outcomes of a decision. To build the tree, the algorithm first finds the variable that does the best task of separating the data into two groups. Then, it repeats the above step with the other variables. The results in a tree graph, where each split represents a decision. The algorithm chooses the splits such that the maximum number of observations are classified correctly. ", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```{r decision tree,  echo = FALSE, warning = FALSE, message = FALSE}", file = variable.name , sep = "\n", append = TRUE)
      cat("##decision tree", file = variable.name , sep = "\n", append = TRUE)
      cat("library(rpart)", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("```", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("###Randon Forest model", file = variable.name , sep = "\n", append = TRUE)
      cat("In Random Forests the idea is to generate several decision trees using different samples randomly chosen from training data.The next step is to simply reduce the variance in the trees by averaging them.", file = variable.name , sep = "\n", append = TRUE)
      cat("Averaging the trees reduces the variance and also improves the perfomance of decision trees on test set and eventually avoids overfitting (that is a too strong dependency of the model on the training set).", file = variable.name , sep = "\n", append = TRUE)
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("```{r random forest, include = FALSE, echo = FALSE, warning = FALSE, message = FALSE}", file = variable.name , sep = "\n", append = TRUE)
      ...
      cat("", file = variable.name , sep = "\n", append = TRUE)
      cat("ggplot(data=pred2, aes(x=coal1Cat, y=sapply(fitted.results.var,mean))) +", file = variable.name , sep = "\n", append = TRUE)
