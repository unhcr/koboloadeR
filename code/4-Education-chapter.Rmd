---
title: "Data Crunching Report: Education- Draft not for distribution. "
...
## During the current school year (201x-xx), did Individual attend any formal/pub
NA
...
### Tabulation
```{r Profile.CaseNoDetails.IndBiodata.YouthEduc.Enrolled.tab, echo=FALSE, warning=FALSE, cache=FALSE, tidy = TRUE, message=FALSE, comment = "", fig.height=1.66666666666667, size="small"}
### Tabulation
##Compute contengency table
frequ <- as.data.frame(table(IndBiodata$Profile.CaseNoDetails.IndBiodata.YouthEduc.Enrolled))
frequ[ ,1] = factor(frequ[ ,1],levels(frequ[ ,1])[order(frequ$Freq, decreasing = FALSE)])
frequ <- frequ[ order(frequ[ , 1]) ,  ]
names(frequ)[1] <- "Enrolled"
## Frequency table with NA in order to get non response rate
frequ1 <- as.data.frame(prop.table(table(IndBiodata$Profile.CaseNoDetails.IndBiodata.YouthEduc.Enrolled, useNA = "ifany")))
...
frequ2 <- as.data.frame(prop.table(table(IndBiodata$Profile.CaseNoDetails.IndBiodata.YouthEduc.Enrolled,useNA = "no")))
## Frequency table with weight
frequ.weight <- as.data.frame(svymean(~ Profile.CaseNoDetails.IndBiodata.YouthEduc.Enrolled, design = IndBiodata.survey, na.rm = TRUE))
## Binding the two
...
xlab("") +
coord_flip() +
ggtitle("During the current school year (201x-xx), did Individual attend any formal/pub",
...
```{r Profile.CaseNoDetails.IndBiodata.YouthEduc.Enrolled1.rel, echo=FALSE, warning=FALSE, cache=FALSE, tidy = TRUE, message=FALSE, comment = "", fig.height=1, size="small"}
crosssfrequ.weight <-as.data.frame(prop.table(svytable(~Profile.CaseNoDetails.IndBiodata.YouthEduc.Enrolled + Location.LocationDistrict, design =IndBiodata.survey  ), margin = 2))
...
xlab("") +
coord_flip() +
ggtitle("During the current school year (201x-xx), did Individual attend any formal/pub (color)",
...
## If Individual did not attend any school, what are the reasons?
NA
...
```{r Profile.CaseNoDetails.IndBiodata.YouthEduc.NotEnrolled.tab, echo=FALSE, warning=FALSE, cache=FALSE, tidy = TRUE, message=FALSE, comment = "", fig.height=8, size="small"}

### Tabulation
##Compute contengency table
selectmultilist1 <- as.data.frame(dico[dico$type == "select_multiple" & dico$listname=="reasons_school" & grepl("NotEnrolled",dico$fullname)==TRUE , c("fullname")])
...
xlab("") +
coord_flip() +
ggtitle("If Individual did not attend any school, what are the reasons?",
subtitle = paste0("Question response rate: ",percentreponse," .")) +
kobo_unhcr_style_bar()
ggpubr::ggarrange(kobo_left_align(plot1, c("subtitle", "title")), ncol = 1, nrow = 1)
...
```{r Profile.CaseNoDetails.IndBiodata.YouthEduc.NotEnrolled.rel, echo=FALSE, warning=FALSE, cache=FALSE, tidy = TRUE, message=FALSE, comment = "", fig.height=4, size="small"}
...
## During the current school year (2017/18), which level and grade was/is ${FirstNa
NA
...
### Tabulation
```{r Profile.CaseNoDetails.IndBiodata.YouthEduc.SchoolLevel.GradeLevel.tab, echo=FALSE, warning=FALSE, cache=FALSE, tidy = TRUE, message=FALSE, comment = "", fig.height=20.8333333333333, size="small"}
### Tabulation
##Compute contengency table
frequ <- as.data.frame(table(IndBiodata$Profile.CaseNoDetails.IndBiodata.YouthEduc.SchoolLevel.GradeLevel))
list.ordinal <- as.character(unique(dico[ dico$listname == "grade" & dico$type == "select_one_d", c("labelchoice") ]))
levels(frequ$Var1) <- list.ordinal
names(frequ)[1] <- "GradeLevel"
## Frequency table with NA in order to get non response rate
frequ1 <- as.data.frame(prop.table(table(IndBiodata$Profile.CaseNoDetails.IndBiodata.YouthEduc.SchoolLevel.GradeLevel, useNA = "ifany")))
frequ1 <- frequ1[!(is.na(frequ1$Var1)), ]
frequ1 <- frequ1[!(frequ1$Var1 == "NA"), ]
percentreponse <- paste0(round(sum(frequ1$Freq)*100,digits = 1),"%")
## Frequency table without NA
frequ2 <- as.data.frame(prop.table(table(IndBiodata$Profile.CaseNoDetails.IndBiodata.YouthEduc.SchoolLevel.GradeLevel,useNA = "no")))
## Frequency table with weight
frequ.weight <- as.data.frame(svymean(~ Profile.CaseNoDetails.IndBiodata.YouthEduc.SchoolLevel.GradeLevel, design = IndBiodata.survey, na.rm = TRUE))
## Binding the two
frequ3 <- cbind(frequ2,frequ.weight)
## Reorder factor
list.ordinal <- as.character(unique(dico[ dico$listname == "grade" & dico$type == "select_one_d", c("labelchoice") ]))
...
xlab("") +
coord_flip() +
ggtitle("During the current school year (2017/18), which level and grade was/is ${FirstNa",
subtitle = paste0(" Question response rate: ",percentreponse," .")) +
kobo_unhcr_style_bar()
ggpubr::ggarrange(kobo_left_align(plot1, c("subtitle", "title")), ncol = 1, nrow = 1)
...
```{r Profile.CaseNoDetails.IndBiodata.YouthEduc.SchoolLevel.GradeLevel1.rel, echo=FALSE, warning=FALSE, cache=FALSE, tidy = TRUE, message=FALSE, comment = "", fig.height=1, size="small"}
crosssfrequ.weight <-as.data.frame(prop.table(svytable(~Profile.CaseNoDetails.IndBiodata.YouthEduc.SchoolLevel.GradeLevel + Location.LocationDistrict, design =IndBiodata.survey  ), margin = 2))
names(crosssfrequ.weight)[1] <- "quest"
names(crosssfrequ.weight)[2] <- "disag"
crosssfrequ.weight$Freq2 <- paste0(round(crosssfrequ.weight$Freq*100,digits = 1),"%")
## Reorder factor
...
xlab("") +
coord_flip() +
ggtitle("During the current school year (2017/18), which level and grade was/is ${FirstNa (color)",
subtitle = " By question: District (bar)") +
kobo_unhcr_style_bar() +
theme(legend.direction = "horizontal", legend.position = "bottom", legend.box = "horizontal",legend.title=element_blank()  )
ggpubr::ggarrange(kobo_left_align(plot1, c("subtitle", "title")), ncol = 1, nrow = 1)
...
## If out of school, please specify number of years out of school:
NA
...
### Tabulation
```{r Profile.CaseNoDetails.IndBiodata.YouthEduc.OutOfSchool.tab, echo=FALSE, warning=FALSE, cache=FALSE, tidy = TRUE, message=FALSE, comment = "", fig.height=6.66666666666667, size="small"}
### Tabulation
##Compute contengency table
frequ <- as.data.frame(table(IndBiodata$Profile.CaseNoDetails.IndBiodata.YouthEduc.OutOfSchool))
frequ[ ,1] = factor(frequ[ ,1],levels(frequ[ ,1])[order(frequ$Freq, decreasing = FALSE)])
frequ <- frequ[ order(frequ[ , 1]) ,  ]
names(frequ)[1] <- "OutOfSchool"
## Frequency table with NA in order to get non response rate
frequ1 <- as.data.frame(prop.table(table(IndBiodata$Profile.CaseNoDetails.IndBiodata.YouthEduc.OutOfSchool, useNA = "ifany")))
frequ1 <- frequ1[!(is.na(frequ1$Var1)), ]
frequ1 <- frequ1[!(frequ1$Var1 == "NA"), ]
percentreponse <- paste0(round(sum(frequ1$Freq)*100,digits = 1),"%")
## Frequency table without NA
frequ2 <- as.data.frame(prop.table(table(IndBiodata$Profile.CaseNoDetails.IndBiodata.YouthEduc.OutOfSchool,useNA = "no")))
## Frequency table with weight
frequ.weight <- as.data.frame(svymean(~ Profile.CaseNoDetails.IndBiodata.YouthEduc.OutOfSchool, design = IndBiodata.survey, na.rm = TRUE))
## Binding the two
frequ3 <- cbind(frequ2,frequ.weight)
## Reorder factor
frequ3[ ,1] = factor(frequ3[ ,1],levels(frequ3[ ,1])[order(frequ3$mean, decreasing = FALSE)])
...
xlab("") +
coord_flip() +
ggtitle("If out of school, please specify number of years out of school:",
subtitle = paste0(" Question response rate: ",percentreponse," .")) +
kobo_unhcr_style_bar()
ggpubr::ggarrange(kobo_left_align(plot1, c("subtitle", "title")), ncol = 1, nrow = 1)
...
```{r Profile.CaseNoDetails.IndBiodata.YouthEduc.OutOfSchool1.rel, echo=FALSE, warning=FALSE, cache=FALSE, tidy = TRUE, message=FALSE, comment = "", fig.height=1, size="small"}
crosssfrequ.weight <-as.data.frame(prop.table(svytable(~Profile.CaseNoDetails.IndBiodata.YouthEduc.OutOfSchool + Location.LocationDistrict, design =IndBiodata.survey  ), margin = 2))
names(crosssfrequ.weight)[1] <- "quest"
names(crosssfrequ.weight)[2] <- "disag"
crosssfrequ.weight$Freq2 <- paste0(round(crosssfrequ.weight$Freq*100,digits = 1),"%")
## Reorder factor
...
xlab("") +
coord_flip() +
ggtitle("If out of school, please specify number of years out of school: (color)",
subtitle = " By question: District (bar)") +
kobo_unhcr_style_bar() +
theme(legend.direction = "horizontal", legend.position = "bottom", legend.box = "horizontal",legend.title=element_blank()  )
ggpubr::ggarrange(kobo_left_align(plot1, c("subtitle", "title")), ncol = 1, nrow = 1)
...
## Have any housebold members received any education or training on hygiene over th
NA
...
### Tabulation
```{r Assistance.AssistanceDetails.EducTrainingHyg.tab, echo=FALSE, warning=FALSE, cache=FALSE, tidy = TRUE, message=FALSE, comment = "", fig.height=1.66666666666667, size="small"}
### Tabulation
##Compute contengency table
frequ <- as.data.frame(table(MainDataFrame$Assistance.AssistanceDetails.EducTrainingHyg))
frequ[ ,1] = factor(frequ[ ,1],levels(frequ[ ,1])[order(frequ$Freq, decreasing = FALSE)])
frequ <- frequ[ order(frequ[ , 1]) ,  ]
names(frequ)[1] <- "EducTrainingHyg"
## Frequency table with NA in order to get non response rate
frequ1 <- as.data.frame(prop.table(table(MainDataFrame$Assistance.AssistanceDetails.EducTrainingHyg, useNA = "ifany")))
frequ1 <- frequ1[!(is.na(frequ1$Var1)), ]
frequ1 <- frequ1[!(frequ1$Var1 == "NA"), ]
percentreponse <- paste0(round(sum(frequ1$Freq)*100,digits = 1),"%")
## Frequency table without NA
frequ2 <- as.data.frame(prop.table(table(MainDataFrame$Assistance.AssistanceDetails.EducTrainingHyg,useNA = "no")))
## Frequency table with weight
frequ.weight <- as.data.frame(svymean(~ Assistance.AssistanceDetails.EducTrainingHyg, design = MainDataFrame.survey, na.rm = TRUE))
## Binding the two
frequ3 <- cbind(frequ2,frequ.weight)
## Reorder factor
frequ3[ ,1] = factor(frequ3[ ,1],levels(frequ3[ ,1])[order(frequ3$mean, decreasing = FALSE)])
...
xlab("") +
coord_flip() +
ggtitle("Have any housebold members received any education or training on hygiene over th",
subtitle = paste0(" Question response rate: ",percentreponse," .")) +
kobo_unhcr_style_bar()
ggpubr::ggarrange(kobo_left_align(plot1, c("subtitle", "title")), ncol = 1, nrow = 1)
...
```{r Assistance.AssistanceDetails.EducTrainingHyg1.rel, echo=FALSE, warning=FALSE, cache=FALSE, tidy = TRUE, message=FALSE, comment = "", fig.height=4, size="small"}
crosssfrequ.weight <-as.data.frame(prop.table(svytable(~Assistance.AssistanceDetails.EducTrainingHyg + Location.LocationDistrict, design =MainDataFrame.survey  ), margin = 2))
names(crosssfrequ.weight)[1] <- "quest"
names(crosssfrequ.weight)[2] <- "disag"
crosssfrequ.weight$Freq2 <- paste0(round(crosssfrequ.weight$Freq*100,digits = 1),"%")
## Reorder factor
...
xlab("") +
coord_flip() +
ggtitle("Have any housebold members received any education or training on hygiene over th (color)",
subtitle = " By question: District (bar)") +
kobo_unhcr_style_bar() +
theme(legend.direction = "horizontal", legend.position = "bottom", legend.box = "horizontal",legend.title=element_blank()  )
ggpubr::ggarrange(kobo_left_align(plot1, c("subtitle", "title")), ncol = 1, nrow = 1)
...
```{r Assistance.AssistanceDetails.EducTrainingHygccc1.rel, echo=FALSE, warning=FALSE, cache=FALSE, tidy = TRUE, message=FALSE, comment = "", fig.height=6, size="small"}
corrplot(chisq.test(MainDataFrame$Assistance.AssistanceDetails.EducTrainingHyg,MainDataFrame$hh.child.head)$residuals,
...
number.cex= 3/ncol(chisq.test(MainDataFrame$Assistance.AssistanceDetails.EducTrainingHyg,MainDataFrame$hh.child.head)), # size of coeff
mar = c(0.5,0.5,4, 0.5), ## margin of plots
title= paste0("Correlation between
Have any housebold members received any education or training on hygiene over th (row)
